...
$id_user = isset($_SESSION['id_user']) ? mysqli_real_escape_string($koneksi, $_SESSION['id_user']) : null;
$list_riwayat = [];
...
if ($id_user) {
    ...
    WHERE pr.id_user = '$id_user'
      AND STR_TO_DATE(CONCAT(r.tanggal_rapat, ' ', r.jam_rapat), '%Y-%m-%d %H:%i:%s') <= NOW()
    ...
    if ($q_read) {
        ...
        // debug sementara: tampilkan error SQL jika perlu
...
<body>
	...
	<section id="sidebar">
		...
		<ul class="side-menu" data-aos="fade-right">
			<li><a href="dashboard.php"><i class="fa-solid fa-calendar-days icon"></i> Agenda Rapat</a></li>
			<li><a href="history.php" class="active"><i class="fa-solid fa-clock-rotate-left icon"></i> Riwayat Rapat</a></li>
			<li><a href="ganti_password.php"><i class="fa-solid fa-gear icon"></i> Ganti Password</a></li>
