...
<html lang="id">
  <head>
    ...
    <title>Pengaturan | Peserta - Rapatin</title>
  </head>
  <body>
    <section id="sidebar">
      <a href="../landing/index.php" class="logo ps-3"><i class="ps-5"></i> Rapatin</a>
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="d-flex justify-content-center align-items-center gap-2 mb-3">
                                <span class="badge bg-primary bg-opacity-10 text-primary px-3 py-2 rounded-pill">
                                    ...
                                    <?= ($current_user['role'] == 'Peserta') ? 'Dosen / Labor' : $current_user['role']; ?>
                                </span>
                            </div>
